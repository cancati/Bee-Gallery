        ...
        <div className={'w-100'} style={{backgroundImage:`url(${background})`,backgroundSize:'cover'}}>
            <Container
                ...
                <div className={'w-75'} style={{display:'flex',minWidth:300,backgroundColor:'#f1a167',padding:20,flexDirection:widthSize <= 800 ? 'column' : 'row',justifyContent:'space-between',alignContent:'space-between',borderRadius:20,}}>
                    <div className={"w-100"} style={{ maxWidth: "400px",minWidth:200,minHeight:100,backgroundColor:'#fed53d',backgroundSize:'cover' ,borderRadius:20,marginRight:20 ,display:'flex',justifyContent:'center',alignItems:'center'}}>
